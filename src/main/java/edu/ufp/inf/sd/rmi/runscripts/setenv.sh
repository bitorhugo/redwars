...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/usr/lib/jvm/java-17-openjdk
...
export USERNAME=arch-bitor

#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=redwars
export JAVAPROJ=${HOME}/projects/${JAVAPROJ_NAME}

export PACKAGE=red
export PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
export PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
export SERVICE_NAME_ON_REGISTRY=RedService
export CLIENT_CLASS_PREFIX=Red
export SERVER_CLASS_PREFIX=Red
